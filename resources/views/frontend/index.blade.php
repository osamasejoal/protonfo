...
<body>
    ...
    <div class="device-notification">
        ...
        <p class="device-notification--message">Osama_Sejoal has so much to offer that we must request you orient your
            device to portrait or find a larger screen. You won't be disappointed.</p>
    </div>
                        ...
                        <li class="l-section section section--is-active">
                            <div class="intro">
                                ...
                                <div class="intro--options">
                                    ...
                                    <!-- Feature 1 -->
                                    <a href="#0">
                                        <h3>{{ $banner->feature_title_1 }}</h3>
                                        <p>{{ $banner->feature_description_1 }}</p>
                                    </a> <!-- end Feature 1 -->

                                    <!-- Feature 2 -->
                                    <a href="#0">
                                        <h3>{{ $banner->feature_title_2 }}</h3>
                                        <p>{{ $banner->feature_description_2 }}</p>
                                    </a><!-- end Feature 2 -->

                                    <!-- Feature 3 -->
                                    <a href="#0">
                                        <h3>{{ $banner->feature_title_3 }}</h3>
                                        <p>{{ $banner->feature_description_3 }}</p>
                                    </a> <!-- end Feature 3 -->
                                ...
                                <div class="work--lockup">
                                    <ul class="slider">
                                        <li class="slider--item slider--item-left">
                                            <a href="#0">
                                                <div class="slider--item-image">
                                                    <img src="{{ asset('frontend') }}/assets/img/work-victory.jpg"
                                                        alt="Victory">
                                                </div>
                                        ...
                                        <li class="slider--item slider--item-center">
                                            <a href="#0">
                                                <div class="slider--item-image">
                                                    <img src="{{ asset('frontend') }}/assets/img/work-metiew-smith.jpg"
                                        ...
                                        <li class="slider--item slider--item-right">
                                            <a href="#0">
                                                <div class="slider--item-image">
                                                    <img src="{{ asset('frontend') }}/assets/img/work-alex-nowak.jpg"
                                                        alt="Alex Nowak">
                                                </div>
