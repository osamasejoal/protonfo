                                ...
                                <div>
                                    <div class="d-flex profile-wrapper">
                                        ...
                                        <ul class="nav nav-pills animation-nav profile-nav gap-2 gap-lg-3 flex-grow-1"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link fs-14" data-bs-toggle="tab" href="#projects"
                                                    role="tab">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);"
                                                                        class="avatar-xs d-block">
                                                                        <span
                                                                            class="avatar-title rounded-circle fs-16 bg-primary-subtle text-primary">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);"
                                                                        class="avatar-xs d-block">
                                                                        <span
                                                                            class="avatar-title rounded-circle fs-16 bg-danger-subtle text-danger">
                                                                ...
                                                                <div>
                                                                    <a href="javascript:void(0);"
                                                                        class="avatar-xs d-block">
                                                                        <span
                                                                            class="avatar-title rounded-circle fs-16 bg-success-subtle text-success">
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-2 fs-15">
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">Photoshop</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">illustrator</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">HTML</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">CSS</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">Javascript</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">Php</a>
                                                                <a href="javascript:void(0);"
                                                                    class="badge bg-secondary-subtle text-secondary">Python</a>
                                                            </div>
                                                        </div><!-- end card body -->
                                                    </div><!-- end card -->
                                                                    ...
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">2 year
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            class="flex-grow-1 text-muted overflow-hidden">
                                                                            <h5 class="fs-14 text-truncate"><a
                                                                                    href="#" class="text-body">ABC
                                                                                    Project
                                                                                    Customization</a></h5>
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">2 month
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                                class="badge bg-info-subtle text-info fs-10">
                                                                                New
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">11 hr
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <h5 class="fs-14 text-truncate"><a
                                                                                    href="#"
                                                                                    class="text-body">Brand Logo
                                                                                    Design</a>
                                                                            </h5>
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">10 min
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">8 hr
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">48 min
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">30 min
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">7 month
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">1 month
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            ...
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">10 month
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
                                                                ...
                                                                <div class="card-body p-4">
                                                                    <div class="d-flex">
                                                                        <div
                                                                            class="flex-grow-1 text-muted overflow-hidden">
                                                                            <h5 class="fs-14 text-truncate"><a
                                                                                    href="#" class="text-body">PSD
                                                                                    to HTML
                                                                                    Convert</a></h5>
                                                                            <p class="text-muted text-truncate mb-0">Last
                                                                                Update : <span
                                                                                    class="fw-semibold text-body">29 min
                                                                                    Ago</span></p>
                                                                        </div>
                                                                        <div class="flex-shrink-0 ms-2">
                                                                            <div
